...
//     const [areaErr, setAreaErr] = useState('');
//     const [addressError, setAddressError] = useState("");
//     const[aadharError,setAadharErr]=useState('');
...
//         try {
//             const response = await axios.get(`https://raviscyber.in/Sevakalpak/index.php/User/GetUser${userId}`);
...
//         }
//         if (aadhar === "") {
//             setAadharErr("Enter your address");
//             isValid = false;
//         } else {
//             setAadharErr("");
//         }
...
//                 <Text style={styles.text}>Addhar Number</Text>
//                 <View style={styles.txtinput}>
//                     <TextInput
//                         style={styles.txtfield}
//                         placeholder="Enter addher number"
//                         value={aadhar}
//                         keyboardType="numeric"
//                         maxLength={12}
...
const ProfileScreen = () => {
    ...
    const handleUpdate = () => {
        ...
        if (aadhar === "") {
            setAadharError("Enter your Aadhar number");
            isValid = false;
        } else {
            setAadharError("");
        }
