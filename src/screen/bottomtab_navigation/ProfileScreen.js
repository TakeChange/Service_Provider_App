...
//         }
//         if (service === "") {
//             setServiceErr("Enter your address");
//             isValid = false;
//         } else {
//             setServiceErr("");
//         }
...
//                 <Text style={styles.text}>Full Name:{uname}</Text>
...
const { uname, mobile, aadhar, area, service, logo, profilephoto, role, address } = route.params;
